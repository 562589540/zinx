...
import (
	...
	"github.com/562589540/zinx/logo"
	"github.com/562589540/zinx/zconf"
	"github.com/562589540/zinx/zdecoder"
	"github.com/562589540/zinx/zlog"
	"github.com/gorilla/websocket"

	"github.com/562589540/zinx/ziface"
	"github.com/562589540/zinx/zpack"
...
type Server struct {
	...
	// 服务绑定的udp 端口 (udp port the server is bound to)
	UdpPort int
...
func (s *Server) Start() {
	...
	case zconf.ServerModeKcp:
		go s.ListenKcpConn()
	case zconf.ServerModeUdp: //udp 配合使用
		go s.ListenTcpConn()
		go s.ListenUDPConn()
	default:
		go s.ListenTcpConn()
